const markWinnerChips = (chips, winnerChips) =>
  winnerChips.forEach((winnerChip) =>
    chips[winnerChip].classList.add("win-chips")
  );
...
const checkBottomChip = (chipPosition, chips, playerTurn) => {
  ...
  while (
    ...
    newChipPosition != 30 &&
    newChipPosition != 36 &&
    chips[newChipPosition - 1].className.includes(playerTurn) &&
    connectedChips < 4
  ) {
    ++connectedChips;
    newChipPosition -= 1;
...
const checkLeftChip = (chipPosition, chips, playerTurn) => {
  ...
  while (
    newChipPosition >= 6 &&
    chips[newChipPosition - 6].className.includes(playerTurn) &&
    connectedChips < 4
  ) {
    ++connectedChips;
    newChipPosition -= 6;
  ...
  return connectedChips === 4
    ? connectedChips
    : checkRightChip(newChipPosition, chips, playerTurn);
};
...
const checkTopLeftChip = (chipPosition, chips, playerTurn) => {
  ...
  while (
    ...
    newChipPosition != 35 &&
    newChipPosition != 41 &&
    chips[newChipPosition - 5].className.includes(playerTurn) &&
    connectedChips < 4
  ) {
    ++connectedChips;
    newChipPosition -= 5;
  ...
  return connectedChips === 4
    ? connectedChips
    : checkBottomRightChip(newChipPosition, chips, playerTurn);
};
...
const checkTopRightChip = (chipPosition, chips, playerTurn) => {
  ...
  while (
    ...
    newChipPosition != 29 &&
    newChipPosition != 35 &&
    chips[newChipPosition + 7].className.includes(playerTurn) &&
    connectedChips < 4
  ) {
    ++connectedChips;
    newChipPosition += 7;
  ...
  return connectedChips === 4
    ? connectedChips
    : checkBottomLeftChip(newChipPosition, chips, playerTurn);
};
